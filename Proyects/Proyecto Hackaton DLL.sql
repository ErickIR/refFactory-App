...
/*
drop table EntidadMunicipal
drop table Cargo
drop table IntegranteJdV
drop table JuntaDeVecinos
drop table Rol
drop table IncidenciaUsuario
drop table Archivo
drop table Incidencia
drop table ExtensionArchivo
drop table TipoArchivo
drop table StatusIncidencia
drop table TipoIncidencia
drop table Usuario
